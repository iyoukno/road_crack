...
if __name__ == '__main__':
    file_path = r'D:\datasets\road_det\CrackForest-dataset-master/groundTruth/'
    png_img_dir = r'D:\datasets\road_det\CrackForest-dataset-master/groundTruthPngImg/'
