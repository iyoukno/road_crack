...
class MKDataset(Dataset):
    def __init__(self, path):
        self.path = path
        self.name = os.listdir(os.path.join(path, 'groundTruthPngImg'))
    ...
    def __getitem__(self, index):
        ...
        img0_path = os.path.join(self.path, 'groundTruthPngImg')
...
if __name__ == '__main__':
    i = 1
    dataset = MKDataset(r'/data0/zjt/datasets/road_seg/CrackForest-dataset-master')
    for a, b in dataset:
        print(i)
        print(a.shape)
        i+=1